...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "kael"         # 用户名
UUID = "765a171f-c83f-4fc4-b645-f053d29614a6"                     # UUID，留空则自动生成
PORT = 49999                   # Vmess端口，留空或0则自动生成
DOMAIN = "freevpn.qingjiao.eu.org"                   # 域名，留空则自动获取
CF_TOKEN = "4lkQQIRd7wj0voYY1-elkC95mHjCXQMJaf0LBs_Y"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
